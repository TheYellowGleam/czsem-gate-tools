...
public class BatikTreeBuilder<E> {
	...
	protected void appendLabel(Element nodeGroup, int line, NodeLabel nodeLabel) {
		...
		createNiceText(nodeLabel.getLeftPart(),  nodeGroup, "end",    -10, txtY);
		createNiceText(nodeLabel.getRightPart(), nodeGroup, "start",  10, txtY);
	}
	
	protected void createNiceText(String textContent, Element nodeGroup, String anchor, int x, int y) {
		...
		textStroke.setTextContent(textContent);
		textStroke.setAttributeNS(null, "font-weight", "bold");
		textStroke.setAttributeNS(null, "alignment-baseline", "text-after-edge");
		textStroke.setAttributeNS(null, "text-anchor", anchor);
		textStroke.setAttributeNS(null, "font-size", Sizing.FONT_SIZE );
		textStroke.setAttributeNS(null, "x", xStr);
		textStroke.setAttributeNS(null, "y", yStr);
